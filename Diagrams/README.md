...
| Авторизированный пользователь   | Пользователь, который авторизировался в приложении   									|
...
## 8.1 Авторизироваться

**Описание.** Вариант использования "Авторизироваться" позволяет пользователю войти в учётную запись.  
**Основной поток.**
...
2. Выполняется вариант использования "[Авторизироваться](#log_in_event)
...
**Предусловия.** Пользователь авторизировался или зарегистрировался.  
**Основной поток.**
...
6. Приложение изменяет информацию о треке в базе данных;
7. Приложение обновляет отображаемый каталог треков;
